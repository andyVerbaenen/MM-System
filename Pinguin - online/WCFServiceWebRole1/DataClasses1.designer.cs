...
namespace WCFServiceWebRole1
{
    ...
    public partial class Speler : INotifyPropertyChanging, INotifyPropertyChanged
	{
        ...
        [DataMember]
		private System.Nullable<int> _Gewonnnen;
        [DataMember]
    ...
    partial void OnGewonnnenChanging(System.Nullable<int> value);
    partial void OnGewonnnenChanged();
    ...
    partial void OnReadyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Gewonnnen", DbType="Int")]
		public System.Nullable<int> Gewonnnen
		{
			get
			{
				return this._Gewonnnen;
			}
			set
			{
				if ((this._Gewonnnen != value))
				{
					this.OnGewonnnenChanging(value);
					this.SendPropertyChanging();
					this._Gewonnnen = value;
					this.SendPropertyChanged("Gewonnnen");
					this.OnGewonnnenChanged();
				}
			}
		}
